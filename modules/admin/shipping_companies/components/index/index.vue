        ...
        >
          <template slot-scope="props">
            ...
            <b-table-column field="phone" :label="$t('admin.phone')" sortable>
             ...
             <b-table-column field="body" :label="$t('admin.body')" sortable>
              <span class="tag">
                {{ props.row.body }}
              </span>
            </b-table-column>
            ...
            <b-table-column field="read_at" :label="$t('admin.read_at')" sortable>
              <span class="tag">
                {{ props.row.read_at!= null ? props.row.read_at :"--" }}
              </span>
            </b-table-column>

            <b-table-column field="replies" :label="$t('admin.replies')" sortable>
              <span class="tag">
            ...
            <b-table-column :label="$t('admin.action')" custom-key="actions" class="is-actions-cell">
              <div class="buttons">
                <nuxt-link
                  :to="{ name: 'admin.contactus.view', params: { id: props.row.id } }"
